...
let events = [
  {
    ...
    description:
      "24-hour coding marathon focusing on AI/ML innovations with $5000 prizes and internship opportunities",
  ...
  },
  {
    ...
    description:
      "Showcase your musical talents in an intimate acoustic setting with live audience",
  ...
  },
  {
    ...
    description:
      "Epic robot combat tournament with custom-built fighting robots",
    ...
    requirements: [
      "Custom Robot (weight limit 5kg)",
      "Safety gear",
      "Remote control",
    ],
    prizes: [
      "Championship Trophy",
      "Tech Gear Worth $2000",
      "Internship Opportunities",
    ],
    schedule: [
  ...
  },
  {
    ...
    description:
      "Learn professional portrait photography techniques from industry experts",
  ...
  },
  {
    ...
    description:
      "Present your business ideas to real investors for seed funding opportunities",
  ...
  },
  {
    ...
    description:
      "Competitive LoL tournament with live streaming and gaming gear prizes",
    ...
    requirements: [
      "League of Legends Account (Gold+ Rank)",
      "Gaming Setup",
      "Team of 5",
    ],
    prizes: [
      "Gaming Gear Worth $3000",
      "Tournament Trophy",
      "Streaming Equipment",
    ],
    schedule: [
  ...
  },
  {
    ...
    description:
      "Discuss environmental challenges and develop sustainable campus solutions",
  ...
  },
  {
    ...
    description:
      "Inter-college debate championship with topics on contemporary global issues",
  ...
  try {
    ...
    if (
      ...
      return res.status(400).json({
        success: false,
        message:
          "Missing required fields: title, description, organizer, date, time, location, category",
      });
    }
